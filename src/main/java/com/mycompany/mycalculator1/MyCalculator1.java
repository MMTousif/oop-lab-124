...
package com.mycompany.mycalculator1;

import java.awt.*;  
import java.awt.event.*;   
  
public class MyCalculator1 extends Frame  
{  
...
///////////////////////////  
MyCalculator1(String frameText)//constructor  
{  
super(frameText);  
...
{  
new MyCalculator1("Calculator - JavaTpoint");  
}  
}  
...
//////////////////////////////////////////  
MyDigitButton(int x,int y, int width,int height,String cap, MyCalculator1 clc)  
{  
super(cap);  
...
MyOperatorButton(int x,int y, int width,int height,String cap, MyCalculator1 clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
if(opText.equals("1/x"))  
    ...
    try  
        ...
        cl.displayLabel.setText(MyCalculator1.getFormattedText(tempd));}  
...
cl.displayLabel.setText(MyCalculator1.getFormattedText(temp));  
//cl.number=temp;  
}//actionPerformed  
}//class  
...
/////////////////////////////////  
MyMemoryButton(int x,int y, int width,int height,String cap, MyCalculator1 clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
case 'R':   
    cl.displayLabel.setText(MyCalculator1.getFormattedText(cl.memValue));break;  
case 'S':  
    cl.memValue=0.0;  
case '+':   
...
MySpecialButton(int x,int y, int width,int height,String cap, MyCalculator1 clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
